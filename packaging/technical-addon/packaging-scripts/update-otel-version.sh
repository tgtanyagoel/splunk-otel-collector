...
sed -i "s/^EXPECTED_ADDON_VERSION?=.*$/EXPECTED_ADDON_VERSION?=${SPLUNK_OTEL_VERSION#v}/g" "$ADDONS_SOURCE_DIR/packaging-scripts/technical-addon/cicd-tests/happypath-test.sh"
